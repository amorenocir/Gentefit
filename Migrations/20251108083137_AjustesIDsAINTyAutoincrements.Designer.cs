...
namespace Gentefit.Migrations
{
    ...
    [Migration("20251108083137_AjustesIDsAINTyAutoincrements")]
    partial class AjustesIDsAINTyAutoincrements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gentefit.Modelo.Enums.Rol", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("Gentefit.Modelo.Usuario", b =>
                {
                    b.HasOne("Gentefit.Modelo.Enums.Rol", "idRolNavigation")
                        .WithMany("Usuarios")
                        .HasForeignKey("idRol")
                        .IsRequired()
