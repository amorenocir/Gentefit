...
namespace Gentefit.Vistas.PantallasEncargado
{
    public partial class ReservasEncargado : Form
    {
        ...
        private void BotonTodo_Click(object sender, EventArgs e)
        {
            ...
            new ListadoReservasEncargado(lista, null, null).Show();
            this.Hide();
        }
        ...
        private void BotonSelecCli_Click(object sender, EventArgs e)
        {
            ...
            new ListadoReservasEncargado(lista, cliente, null).Show();
            this.Hide();
        }
        ...
        private void BotonSelecCla_Click(object sender, EventArgs e)
        {
            ...
            new ListadoReservasEncargado(lista, null, clase).Show();
            this.Hide();
        }
